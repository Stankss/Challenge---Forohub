...
public class LoginController {
    ...
    @Tag(name = "post", description = "Método POST de API para autenticar los usuarios")
    @Operation(
            summary = "Autentica usuario",
            description = "Autenticar usuario y obtener su JWT correspondiente. Necesita enviar el campo login y clave para poder autenticarse."
    )
    @PostMapping
